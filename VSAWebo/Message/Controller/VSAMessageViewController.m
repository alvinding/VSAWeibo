...
@interface VSAMessageViewController ()

@end

@implementation VSAMessageViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    VSATest1ViewController *test1VC = [[VSATest1ViewController alloc] init];
